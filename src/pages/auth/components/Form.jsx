...
const Form = ({type, onSubmit}) => {
  ...
  //Data is updated when the user types in the form
        ...
        <div className="max-w-md mx-auto">
          <div>
            <h1 className="text-2xl font-semibold">
              { type === "Login" ? "Login here to contiue...." : "Register here to contiue...." }
              </h1>
          </div>
          ...
          {
            type=== 'register' ? 
            <Link to="/login" style={{color:'blue'}}>Go to Register</Link>
            :
            <Link to="/register" style={{color:'blue'}}>Go to Login</Link>
          } 
          </form>
